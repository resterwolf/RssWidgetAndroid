package com.restwl.rsswidget.model;
...
import com.restwl.rsswidget.utils.WidgetConstants;
...
public class News {
    ...
    private DateFormat getRssDateFormat() {
        return new SimpleDateFormat(WidgetConstants.RSS_DATE_FORMAT, Locale.ENGLISH);
    }
